...
const POSTS = [
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    excerpt: `Why we rebuilt ${BRAND_NAME} into a single platform — and what it means for your agency workflow.`,
    category: 'Product',
    tags: ['Product', 'Strategy', 'Roadmap'],
    author: { name: 'Aarav Mehta', role: `CEO, ${BRAND_NAME}`, initial: 'AM' },
    date: '2026-04-30',
    readTime: '6 min read',
    ...
    body: [
      ...
      { type: 'p', children: <>When we started {BRAND_NAME} in early 2024, the modern marketing agency stack looked something like this: one tool for analytics, another for scheduling, a third for messaging, a Google Sheet for reporting, a Slack channel for approvals, and a calendar app to glue it all together.</> },
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: 'p', children: <>At inference time we send {BRAND_NAME} the profile, plus the prompt, plus a tiny set of 3 anchor examples chosen for similarity to the prompt. Total context: under 3 KB. The model writes in your voice without ever seeing your full archive.</> },
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    accent: '#22c55e',
    body: [
      { type: 'lead', text: `WhatsApp is no longer optional in India. Here's the playbook your agency clients should be running in 2026 — drawn from the top decile of accounts on ${BRAND_NAME}.` },
      ...
      { type: 'p', children: <>Agencies running this flow on {BRAND_NAME} see 30%+ click rates on weekly drops. The ones still doing list-broadcasts see 2%.</> },
      ...
      { type: 'p', children: <>Inside {BRAND_NAME}, set up automations for: out-of-hours acknowledgements, FAQ deflection (50% of inbound DMs are "what are your prices?" — answer with a smart flow), and second-touch follow-ups for unresponded leads after 24 hours.</> },
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    accent: '#ec4899',
    body: [
      { type: 'lead', text: `We rebuilt the ${BRAND_NAME} design system in three months — in public, with customers using it the whole time. Here's what worked and what almost killed us.` },
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: 'callout', children: <>The Reports module on {BRAND_NAME} templates these five charts out of the box. Customise once, schedule monthly, white-label, done.</> },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: 'ul', items: [
        ...
        <>A small {BRAND_NAME} call per platform that adapts the prose without changing voice.</>,
