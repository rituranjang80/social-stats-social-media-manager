      ...
      {step === 1 && (
        <div style={ds.confirmBox}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={ds.confirmDesc}>{`Please select a reason. This helps us improve ${BRAND_NAME}.`}</p>
...
function AgencyTab({ user, refreshAuth, navigate }) {
  ...
  return (
    <div style={s.tabContent}>
      ...
      <p style={s.sectionSub}>{`Manage your connection to your agency on ${BRAND_NAME}.`}</p>
