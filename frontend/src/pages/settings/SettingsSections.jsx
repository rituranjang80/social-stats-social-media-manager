...
export function CrossLinksSection({ user }) {
  ...
  const LINKS = [
    ...
    { to: `${base}/account-settings/welcome-email-template`, label: 'Email templates', description: 'Welcome, client approval digests, and more (HTML, placeholders).', staffOnly: true },
    { to: `${base}/analytics/audit-log`, label: 'Audit log',     description: 'Search every action across your account.',             staffOnly: true },
    { to: `${base}/error-logs`,    label: 'Error logs',    description: 'Backend and frontend exceptions (with optional page screenshots).', staffOnly: true },
