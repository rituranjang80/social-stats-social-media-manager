# Fix Terms & Privacy: clarify that Social State reads analytics from social platforms
                ...
                'sections': [
                    {
                        ...
                        'html': (
                            '<p>Social State ("we", "our", or "us") operates a social media analytics and content-planning '
                            'platform at <strong>socialstate.ai</strong>. We connect to Facebook, Instagram, Google, YouTube, '
                            ...
                            'the rights available to you. By using Social State you agree to this Privacy Policy. If you do not agree, '
                    ...
                    },
                    {
                        ...
                        'html': (
                            ...
                            '<li><strong>User-created content</strong> — calendar posts, notes, AI-generated captions, and post ideas you create within Social State for your own planning purposes</li>'
                            '</ul>'
            ...
            'content': {
                ...
                'sections': [
                    ...
                    },
                    {
                        ...
                        'html': (
                            '<p>Social State is a social media analytics and content-planning platform that connects to your '
                            ...
                            'your social media posts within Social State</li>'
                            ...
                            '</ul>'
                            '<p><strong>How we interact with your social accounts:</strong> Social State retrieves analytics data '
                            ...
                            'in the Social State content calendar (drafts, scheduled posts, captions) is stored within Social State only and '
                    ...
                    },
                    {
                        ...
                        'html': (
                            ...
                            'official API under your explicit OAuth consent. Social State requests <strong>read-only permissions</strong> '
